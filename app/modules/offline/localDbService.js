            ...
            function ($q, indexedDB) {
                ...
                var _db = {
                    ...
                    requireObjectStoreName: function (objectStoreName, deferred) {
                        if (typeof (objectStoreName) === 'undefined' || !objectStoreName ||
                    ...
                    insert: function (objectStoreName, data, keyName) {
                        ...
                        var store = _db.getObjectStore(objectStoreName,
                            _db.transactionTypes.readwrite);
                        var request;
                    ...
                    'delete': function (objectStoreName, key) {
                        ...
                        var
                            store = _db.getObjectStore(objectStoreName, _db.transactionTypes.readwrite),
